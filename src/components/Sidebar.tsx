...
const navItems = [
  ...
  { href: "/rayonlar", label: "Rayonlar", icon: MapPin },
...
const bottomItems = [
  ...
  { href: "/is-elani-yerlesdir", label: "Elan yerləşdir", icon: FileText },
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col gap-6 border-r border-slate-200 bg-white px-4 py-6 lg:flex dark:border-slate-800 dark:bg-[#0f172a]">
